...
<body>
    ...
    <section class="jm-section m-t-30" id="about">
        <div class="jm-container">
            ...
            <div class="jm-grid-2">
                <div class="collection scrollflow -slide-top -opacity">
                    <img src="<?php echo RUTA_IMG?>logo/benitan1.png">
                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect jm-button jm-button--black"><span class="jm-dollar">$29</span>Add To Cart</button>
                    <p>Made to serve as a reminder that the time we have is limited. Don’t spend it staring of screen.</p>
                </div>
                <div class="collection scrollflow -slide-top -opacity">
